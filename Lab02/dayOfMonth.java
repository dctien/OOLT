...
public class dayOfMonth {
	...
	public static void main(String[] args) {
		...
		if(checkLeapYear(year)) {
			System.out.printf("Number day of month %s is %d %n", monthOfYear, leapYear[temp-1]);
		}else {
			System.out.printf("Number day of month %s is %d %n", monthOfYear, commonYear[temp-1]);
		}
